...
![Hooks folder](screenshots/hook_folder.png)
...
![User prompt Script](screenshots/userp_script.png)
...
![Pretool Guard Script](screenshots/pretool_hook.png)
...
![Post tool Logger script](screenshots/post_tool.png)
...
![Settings Config](screenshots/settings_json.png)
...
![Hook Block Destructive prompt](screenshots/block_prompt.png)
---
...
![PreToolUse Hook block destroy prompt](screenshots/pretool_block.png)
---
...
![Claude running validate successfully](screenshots/validate.png)
---

#### Screenshot 9 — `.claude/deploy.log` showing the logged command

![Claude Deploy Log](screenshots/deploy.png)
---
