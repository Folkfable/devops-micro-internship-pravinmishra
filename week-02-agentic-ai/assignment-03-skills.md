...
![Claude Skills](screenshots/claude_skills.png)
...
![Scaffold Terraform](screenshots/scaffold_terraform.png)

---

#### Screenshot 3 — Screenshot 3 — `tf-plan/SKILL.md` frontmatter showing `allowed-tools: Bash, Read, Grep` (no Write) and `disable-model-invocation: true`

![TF Plan](screenshots/tf_plan.png)
...
![Generated Terraform](screenshots/gen_terraform.png)
...
![Terrafform fodler](screenshots/terraform_folder.png)
...
![Terraform failed](screenshots/tf_failed.png)
